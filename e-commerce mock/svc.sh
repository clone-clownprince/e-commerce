...
SVC_NAME="actions.runner.clone-clownprince-e-commerce-mock.of-crime.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (clone-clownprince-e-commerce-mock.of-crime)"
